...
namespace NichiforVlad
{
    public partial class Transfer : Form
    {
        ...
        private void Transfer_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'transferDS.DataTable1' table. You can move, or remove it, as needed.
            this.dataTable1TableAdapter.Fill(this.transferDS.DataTable1);
        ...
        private void legareControale(bool v)
        {
            if (v)
            {
                ...
                lIdTr.DataBindings.Add("Text", dataTable1BindingSource, "id_transfer");
        ...
        private void adauga_inregistrare()
        {
            ...
            cmd.CommandText = "Insert into Transfer(" + listaCampuri + ") " + "Select " + listaValori;
        ...
        {
            dataTable1TableAdapter.Fill(transferDS.DataTable1);
        ...
        private void modifica_inregistrare()
        {
            ...
            cmd.CommandText = "Update Transfer Set " + listaSet + " Where id_transfer =" + lIdTr.Text;
            MessageBox.Show(cmd.CommandText);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void bStergere_Click(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = dataTable1TableAdapter.Connection.ConnectionString;
            cmd.Connection = con;
            cmd.CommandText = "Delete From Transfer Where id_transfer = " + lIdTr.Text;
            MessageBox.Show(cmd.CommandText);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
